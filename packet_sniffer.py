    ...
    while True:
        ...
        if eth_proto == 8:
            ...
            # TCP
                ...
                (src_port, dest_port, sequence, acknowledgegement, flag_urg, flag_ack, flag_psh, flag_rst, flag_syn,
...
def tcp_segment(data):
    ...
    return src_port, dest_port, sequence, acknowledgegement, flag_urg, flag_ack, flag_psh, flag_rst, flag_syn, flag_fin, data[
                                                                                                                         offset:]
